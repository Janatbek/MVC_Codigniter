...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>Physical Therapy Pro Center</title>
	...
	<body class="no-trans front-page transparent-header gradient-background-header page-loader-1">
		...
		<div class="page-wrapper">
							...
							<div class="col-md-1  hidden-xs ">
								...
								<div class="header-left clearfix">
									...
									<div id="logo" class="logo">
										<a href="index.html"><img id="logo_img" src="../../assets/images/logo-y1.png" alt="The Project"></a>
									</div>
											...
											<div class="navbar-header">
												...
												<div class="header-left clearfix  visible-xs ">
													...
													<div id="logo-mobile" class="logo">
														<a href="index.html"><img id="logo-img-mobile" src="../../assets/images/logo_vivid_red.png" alt="The Project"></a>
													</div>
						...
						<div id="slider-banner-fullwidth-hero" class="slider-banner-fullwidth-hero dotted rev_slider" data-version="5.0">
							<ul class="slides">
								...
								<div class="tp-caption medium_white text-center hidden-xs"
									...
									data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">A Holistic Approach to Physical Therapy<br>Combining European with American approaches to healing<br>
								</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<h1 class="text-center large">Welcome to The <br><span class="text-default">Physical Therapy Pro center</span></h1>
			...
			<section class="pv-40 clearfix">
				<div class="white-bg owl-carousel content-slider-with-large-controls">
					<div class="container">
						<div class="row">
			...
			<!-- section -->
			<!-- ================ -->
			<section class="pv-40 dark-translucent-bg" style="background: url(../../assets/imagesfrom/therapeutic1.jpg) 50% 0px no-repeat;">
				<div class="container">
				...
				<div class="container-fluid">
					<div class="row grid-space-0">
						<div class="col-sm-3">
							<div class="team-member image-box style-2 text-center">
								<div class="overlay-container overlay-visible">
									<img src="../../assets/images/gym-team-1.jpg" alt="">
						...
						<div class="col-sm-3">
							<div class="team-member image-box style-2 text-center">
								<div class="overlay-container overlay-visible">
									<img src="../../assets/images/gym-team-2.jpg" alt="">
									<div class="overlay-bottom">
										<ul class="social-links circle dark margin-clear">
											<li class="skype"><a target="_blank" href="http://www.skype.com"><i class="fa fa-skype"></i></a></li>
											<li class="linkedin"><a target="_blank" href="http://www.linkedin.com"><i class="fa fa-linkedin"></i></a></li>
						...
						<div class="col-sm-3">
							<div class="team-member image-box style-2 text-center">
								<div class="overlay-container overlay-visible">
									<img src="../../assets/images/gym-team-3.jpg" alt="">
									<div class="overlay-bottom">
										<ul class="social-links circle dark margin-clear">
											<li class="skype"><a target="_blank" href="http://www.skype.com"><i class="fa fa-skype"></i></a></li>
											<li class="linkedin"><a target="_blank" href="http://www.linkedin.com"><i class="fa fa-linkedin"></i></a></li>
						...
						<div class="col-sm-3">
							<div class="team-member image-box style-2 text-center">
								<div class="overlay-container overlay-visible">
									<img src="../../assets/images/gym-team-4.jpg" alt="">
									<div class="overlay-bottom">
										<ul class="social-links circle dark margin-clear">
											<li class="skype"><a target="_blank" href="http://www.skype.com"><i class="fa fa-skype"></i></a></li>
											<li class="linkedin"><a target="_blank" href="http://www.linkedin.com"><i class="fa fa-linkedin"></i></a></li>
			...
			<!-- section start -->
			<!-- ================ -->
			<section class="default-translucent-bg parallax-2 pv-40" style="background: url(../../assets/images/gym-background-img-2.jpg) 50% 50% no-repeat;">
				<br>
				<br>
				<br>
				<div class="container">
